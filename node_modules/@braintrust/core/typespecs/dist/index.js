...
__export(index_exports, {
  ...
  stopFunctionSchema: () => stopFunctionSchema,
...
var strictParam = import_zod10.z.boolean().nullish().describe(
  "If true, throw an error if one of the variables in the prompt is not present in the input"
);
var codeBundleSchema = import_zod10.z.object({
  runtime_context: runtimeContextSchema,
  location: import_zod10.z.union([
    import_zod10.z.object({
      type: import_zod10.z.literal("experiment"),
      eval_name: import_zod10.z.string(),
      position: import_zod10.z.union([
        import_zod10.z.object({ type: import_zod10.z.literal("task") }),
        import_zod10.z.object({
          type: import_zod10.z.literal("scorer"),
  ...
  bundle_id: import_zod10.z.string(),
  preview: import_zod10.z.string().nullish().describe("A preview of the code")
}).openapi("CodeBundle");
var functionDataSchema = import_zod10.z.union([
  import_zod10.z.object({
    type: import_zod10.z.literal("prompt")
    // For backwards compatibility reasons, the prompt definition is hoisted out and stored
    // in the outer object
  }).openapi({ title: "prompt" }),
  import_zod10.z.object({
    type: import_zod10.z.literal("code"),
    data: import_zod10.z.union([
      import_zod10.z.object({
        type: import_zod10.z.literal("bundle")
      }).and(codeBundleSchema).openapi({ title: "bundle" }),
      import_zod10.z.object({
        type: import_zod10.z.literal("inline"),
        runtime_context: runtimeContextSchema,
  ...
  import_zod10.z.object({
    type: import_zod10.z.literal("global"),
...
var functionIdSchema = import_zod10.z.union([
  ...
  import_zod10.z.object({
    ...
    name: import_zod10.z.string().nullish().describe("The name of the inline function")
  }).describe("Inline function definition").openapi({ title: "inline_function" })
...
var stopToken = import_zod10.z.string().nullish().describe("The token to stop the run");
var runEvalSchema = import_zod10.z.object({
  ...
  max_concurrency: import_zod10.z.number().nullish().transform((val) => val === void 0 ? 10 : val).describe(
  ...
  extra_messages: import_zod10.z.string().optional().describe(
...
var stopFunctionSchema = import_zod10.z.object({
  stop_token: import_zod10.z.string().describe("The token to stop the run")
...
var onlineScoreConfigSchema = import_zod11.z.object({
  ...
  skip_logging: import_zod11.z.boolean().nullish().describe("Whether to skip adding scorer spans when computing scores")
}).refine((val) => {
  var _a2;
...
function generateBaseEventOpSchema(objectType) {
  ...
  return import_zod12.z.object({
    ...
    _pagination_key: import_zod12.z.string().nullish().describe(
...
var asyncScoringStateSchema = import_zod12.z.union([
  import_zod12.z.object({
    ...
    skip_logging: import_zod12.z.boolean().nullish()
  }),
  // Explicitly disabled.
  import_zod12.z.object({
