...
var strictParam = z10.boolean().nullish().describe(
  "If true, throw an error if one of the variables in the prompt is not present in the input"
);
var codeBundleSchema = z10.object({
  runtime_context: runtimeContextSchema,
  location: z10.union([
    z10.object({
      type: z10.literal("experiment"),
      eval_name: z10.string(),
      position: z10.union([
        z10.object({ type: z10.literal("task") }),
        z10.object({
          type: z10.literal("scorer"),
  ...
  bundle_id: z10.string(),
  preview: z10.string().nullish().describe("A preview of the code")
}).openapi("CodeBundle");
var functionDataSchema = z10.union([
  z10.object({
  ...
  z10.object({
    type: z10.literal("code"),
    data: z10.union([
      z10.object({
        type: z10.literal("bundle")
...
var functionIdSchema = z10.union([
  ...
  z10.object({
    ...
    name: z10.string().nullish().describe("The name of the inline function")
...
var stopToken = z10.string().nullish().describe("The token to stop the run");
var runEvalSchema = z10.object({
  ...
  max_concurrency: z10.number().nullish().transform((val) => val === void 0 ? 10 : val).describe(
  ...
  extra_messages: z10.string().optional().describe(
...
var stopFunctionSchema = z10.object({
  stop_token: z10.string().describe("The token to stop the run")
...
var onlineScoreConfigSchema = z11.object({
  ...
  skip_logging: z11.boolean().nullish().describe("Whether to skip adding scorer spans when computing scores")
}).refine((val) => {
  var _a;
...
function generateBaseEventOpSchema(objectType) {
  ...
  return z12.object({
    ...
    _pagination_key: z12.string().nullish().describe(
...
var asyncScoringStateSchema = z12.union([
  z12.object({
    ...
    skip_logging: z12.boolean().nullish()
  }),
  // Explicitly disabled.
  z12.object({
