...
var init_stream = __esm({
  "src/functions/stream.ts"() {
    "use strict";
    braintrustStreamChunkSchema = z.union([
      z.object({
...
function renderPromptParams(params, args, options) {
  const schemaParsed = z2.object({
    response_format: z2.object({
      type: z2.literal("json_schema"),
      json_schema: responseFormatJsonSchemaSchema.omit({ schema: true }).extend({
        schema: z2.unknown()
      })
    })
  }).safeParse(params);
...
`,
    ...
    Dataset = class extends ObjectFetcher {
      ...
      async summarize(options = {}) {
        ...
        let dataSummary;
        if (summarizeData) {
          const rawDataSummary = z2.object({
            total_records: z2.number()
          }).parse(
      ...
      runBuild(buildArgs, options) {
        ...
        if (flavor === "chat") {
          ...
          return {
            ...renderPromptParams(params, variables, { strict: options.strict }),
            ...spanInfo,
            prompt: Mustache2.render(prompt.content, variables, void 0, {
              escape
            })
          };
        } else {
...
try {
  if (__require.resolve("@anthropic-ai/sdk")) {
...
export {
  ...
  withParent,
  wrapAISDKModel,
  wrapAnthropic2 as wrapAnthropic,
  wrapOpenAI,
  wrapOpenAIv4,
  wrapTraced
};
