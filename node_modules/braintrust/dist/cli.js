  ...
  "package.json"(exports2, module2) {
    module2.exports = {
      ...
      scripts: {
        ...
        test: "vitest run --exclude src/wrappers/anthropic.test.ts",
...
function formatNameAndSlug(pieces) {
  ...
  return {
    name: (0, import_core4.capitalize)(nonEmptyPieces.join(" ")),
...
async function pullCommand(args) {
  ...
  const functions = await loggerConn.get_json("/v1/function", {
    ...
    ...args.id ? { ids: [args.id] } : {},
    ...args.version ? { version: (0, import_core5.loadPrettyXact)(args.version) } : {}
  });
...
function makeFunctionDefinition({
  ...
  const paramsString = params && Object.keys(params).length > 0 ? `params: ${import_util5.default.inspect(params, { depth: null }).trimStart()},` : "";
  const tools = [
    ...func.prompt_data.tool_functions ?? [],
    ...rawTools
  ];
  const toolsString = tools.length > 0 ? `tools: ${import_util5.default.inspect(tools, { depth: null }).trimStart()},` : "";
...
function printOptionalField(fieldName, fieldValue) {
  return !(0, import_core5.isEmpty)(fieldValue) ? `
...
var markKnownPackagesExternalPlugin = {
  name: "make-known-packages-external",
  setup(build2) {
    const knownPackagesFilter = /^(braintrust|autoevals|@braintrust\/|config|lightningcss)/;
